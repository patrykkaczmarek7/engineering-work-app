...
<html lang="en">
    ...
    <head>
        ...
        <body>
            ...
            <div id="content">
                ...
                <nav id="top-nav" class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <h2 id="rotation" class="alert alert-danger text-center" role="alert">Rotate your device <i class="fa fa-mobile"></i> <br/> and refresh the page</h2>
                        ...
                        <a href="klienci_dodaj.php" type="button" class="btn btn-success">Add</a>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-12">
                                ...
                                <?php
                                    $query = 'SELECT * FROM klienci_crud';
                                    $stmt = $conn->prepare($query);
                                    $stmt->execute();
                                    $result = $stmt->get_result();
                                ?>
                                <!-- Inscription -->
                                <h3 class="text-center text-dark mt-2">Customers using our service</h3>
                                <hr />
                                <br />
                                <table class="table table-hover" id="data-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <!-- Action Buttons -->    
                                            <a href="klienci_details.php?details=<?= $row['id']; ?>" class="badge badge-primary p-2">Extend</a> <br/>
                                            <a href="klienci_action.php?delete=<?= $row['id']; ?>" class="badge badge-danger p-2" onclick="return confirm('Do you want to delete this client?');">Delete</a> <br/> 
                                            <a href="klienci_dodaj.php?edit=<?= $row['id']; ?>" class="badge badge-success p-2">Edit</a> 
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
            ...
            <!-- Rotation. If screen is less than 500px, than alert is shown -->
            ...
            <script>   
                $(document).ready(function() {
                    $('#data-table').DataTable({
                        "language": {
                            "lengthMenu": "View _MENU_ clients:",
                            "search": "Search:",
                            "previous":   "Previous",
                            "zeroRecords": "Client not found",
                            "info": "Page _PAGE_ from _PAGES_",
                            "infoEmpty": "No results to display",
                            "infoFiltered": "(Searching from _MAX_ clients)",
                            "paginate": {
                                "first": "First",
                                "last": "Last",
                                "next": "Next",
