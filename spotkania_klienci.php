...
<html lang="en">
    <head>
        ...
        <title>Meetings with clients</title>
        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <a class="navbar-brand"><i class="fa fa-address-card-o"></i><b> Meetings with clients:</b></a>
                    <a href="https://calendar.google.com/calendar/u/1/r?pli=1" target="_blank" type="button" class="btn btn-success">Add</a>
                </div>

                <div class="container-fluid">
                    <div class="row my-5">
                    <iframe src="https://calendar.google.com/calendar/b/2/embed?height=700&amp;wkst=1&amp;bgcolor=%23ffffff&amp;ctz=Europe%2FWarsaw&amp;src=dXQ4ODc3Nmw2NG1kaHJycDJvaXEycnJyNDRAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ&amp;color=%239E69AF&amp;showPrint=0&amp;showTabs=0&amp;showCalendars=0&amp;showTz=0&amp;showTitle=0" style="border-width:0" width="100%" height="700" frameborder="0" scrolling="no"></iframe>
                    </div>
                </div>
