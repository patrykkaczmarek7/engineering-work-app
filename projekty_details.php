            ...
            <div id="content">
                ...
                <div class="row">
                    ...
                    <div class="mx-auto col-md-8 bg-light p-2 rounded p-4 rounded">
                        <h3 class="text-center text-dark mt-2">Project: <?= $domain; ?></h3>
                        <hr />
                        <br />
                        
                        <div class="row justify-content-center">
                            <div class="text-center">
                                <h4 class="text-dark">ID: <?= $vid; ?></h4>
                                <h4 class="text-dark">Client: <?= $vname; ?></h4>
                                <h4 class="text-dark">Price: <?= $price; ?></h4>
                                <br />
                                <a href="projekty.php" class="btn btn-info text-center" value="return"><i class="fa fa-arrow-left"> Return</i></a>
                            </div>
                        </div>
                    </div>
                </div>
